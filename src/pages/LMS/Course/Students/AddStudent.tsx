...
import { COURSES, USERS } from '../../../../Api/Api';
...
const AddStudent = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      await Axios.put(`${COURSES}/${id}/addStudents`, { studentIds: getIds });
  ...
  const {} = useQuery({
    queryFn: async () => await Axios.get(`${COURSES}/${id}`),
    queryKey: ['singleCourseAndStudents'],
    onSuccess: (data) => {
      setStudents(
